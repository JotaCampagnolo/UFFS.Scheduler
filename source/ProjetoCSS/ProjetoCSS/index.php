...
<!-- Navigation -->
    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          <div class="intro-lead-in">BEM VINDO AO UFFS SCHEDULER</div>
          <div class="intro-heading">Organizando sua vida acadêmica!</div>
        </div>
      </div>
    </header>
    ...
    <section class="bg-light" id="team">
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h2 class="section-heading">Conheça nosso time</h2>
             </div>
        </div>
        <div class="row">
          <div class="col-sm-3">
